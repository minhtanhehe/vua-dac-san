...
console.log(`Internal service clients configured in Finance Service: Auth -> ${authServiceUrl}, Order -> ${orderServiceUrl}, Product -> ${productServiceUrl}, Warehouse -> ${warehouseServiceUrl}`);
